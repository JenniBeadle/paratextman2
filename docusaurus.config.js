...
const config = {
  ...
  projectName: 'paratextman2', // Usually your repo name.
  ...
  i18n: {
    defaultLocale: 'en',
    locales: ['en', 'fr', 'es', 'id', 'pt', 'ru', 'hi', 'ar', 'ml', 'zh-CN', 'zh-TW'], 
  },
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/JenniBeadle/paratextman2/tree/main',
        },
        blog: false,
  ...
  themeConfig:
    ...
    ({
      navbar: {
        ...
        items: [
          {
            href: 'https://github.com/JenniBeadle/paratextman2/',
            label: 'GitHub',
            position: 'right',
          },
          {
